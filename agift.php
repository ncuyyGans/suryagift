...
echo "| Simpel script by Suryadi:v \n";
echo "|  \n";
echo "| --------------------------- \n";
...
$data_create = '{"address":"","birthDate":"1991-10-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":"MantapJiwa","phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
